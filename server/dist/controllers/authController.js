...
exports.signUpPost = (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        passport_1.default.authenticate("signup", { session: false }, function (err, user, info) {
            if (err || !user) {
                ...
                var message = info ? info.message : "An error occurred.";
...
exports.logInPost = (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    req.login(user, { session: false }, function (error) { return __awaiter(void 0, void 0, void 0, function () {
                        var body, token, message;
                        return __generator(this, function (_a) {
                            if (error)
                                return [2 /*return*/, next(error)];
                            body = { _id: user._id, username: user.username };
                            token = jsonwebtoken_1.default.sign({ user: body }, process.env.signature, {
                                expiresIn: "1hr",
                            });
                            message = info.message;
                            return [2 /*return*/, res.json({ message: message, token: token })];
                        });
                    }); });
                }
                catch (error) {
