...
describe("POST /signup", function () {
    ...
    it("should not create a user if username already exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app).post("/signup").send(testUser)];
                case 1:
                    ...
                    expect(response.body.message).toBe("Username, ".concat(testUser.username, ", already exists."));
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it("should not login if username and password are incorrect", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app).post("/login").send(wrongCredentials)];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(400);
